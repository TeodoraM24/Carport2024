...
public class PartsListCalculator {
    ...
    private void calcPost() {
        ...
        post.setLength(carportHeight + 90);
    ...
    public int calcPostQuantity() {
        ...
        return (2 * (2 + (carportLength - removeDistanceLength) / maxDistancePost));
    }

    public int calcAvgDistanceBetweenPosts() {
        return (int) Math.floor((double) (carportLength - removeDistanceLength) / (((double) calcPostQuantity() /2)-1));
    }

    public int calcRemainingDistance() {
        int remainingDistance = 0;
        int totalLength = (carportLength - removeDistanceLength);
